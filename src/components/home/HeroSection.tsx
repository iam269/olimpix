      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-primary font-medium">Pregătire pentru olimpiade 2024</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground">Lecții</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold gradient-text mb-1">5</div>
              <div className="text-sm text-muted-foreground">Nivele</div>
            </div>
          </div>
        </div>
      </div>
