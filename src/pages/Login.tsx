  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">
            Continuă-ți pregătirea pentru olimpiadă
          </p>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-card relative overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-60 h-60 bg-accent/20 rounded-full blur-3xl" />
        ...
        <div className="text-center relative z-10 p-12">
          ...
          <p className="text-xl text-muted-foreground max-w-md">
            Drumul tău către olimpiadă începe aici
          </p>
        </div>
      </div>
    </div>
